...
| FFmpegKit maintained fork | First FFmpeg compatibility remux/extract path | LGPL-3.0 | Active | Uses `dev.ffmpegkit-maintained:ffmpeg-kit-free-71:7.1.5` or the matching local GitHub Release AAR fallback, 7.1 LTS Free tier, arm64-v8a only, no `-gpl` artifact. |
